...
volatile uint8_t ledPins[] = {A2,A1,A0,15,14,16,A3};
volatile uint8_t buttonPins[] = {4,5,6,7,8,9,10};
volatile uint8_t muiltPins[][3] = {{10,4,8}, {10,5,8}, {10,6,8}, {10,7,8}, {10,8,8}, {10,9,8}, {10,4,7}};
